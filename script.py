...
# ---- Airia Webhook ----
AIRIA_API_URL = "https://api.airia.ai/v2/PipelineExecution/77c8ca50-1389-4aae-a956-aab3d27d489c"
AIRIA_API_KEY = "ak-MjIxNTg0NjYxOXwxNzc0NDQ5MzAxMzUyfHRpLVUwVk5TMGhTUXkxUGNHVnVJRkpsWjJsemRISmhkR2x2YmkxQmFYSnBZU0JHY21WbHwxfDE2MTk0NzY0ODAg"
...
def capture_traffic():
    ...
    capture_cmd = [
        "tshark",
        "-i", INTERFACE,
        "-f", "icmp and dst host 192.168.1.11", 
